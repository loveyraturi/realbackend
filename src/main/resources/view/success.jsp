...
<body>
	...
	<div class="outer" style="box-shadow: 3px 3px 5px 6px #ccc; width: 37%; margin: 6% auto;">
		...
		<div class="title" style="text-align: center;">Payment Successful</div>
		<div class="inner" style="text-align: center;padding-bottom: 5%;">Your payment was successful</div>
		</div>
